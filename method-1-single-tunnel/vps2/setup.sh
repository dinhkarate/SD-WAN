#!/bin/bash
#===============================================================================
# VPS2 Setup Script - WireGuard Server + NAT (Method 1)
# Chức năng: WireGuard Server nhận kết nối từ PC, NAT ra Internet
#===============================================================================

set -e

echo "================================================"
echo "  VPS2 WireGuard Server Setup (Method 1)"
echo "================================================"
...
echo ""
echo "================================================"
echo "  🔑 VPS2 PUBLIC KEY (lưu lại để cấu hình PC):"
echo "================================================"
cat vps2_publickey
echo "================================================"
echo ""
...
echo "  2. Firewall cần mở UDP port 51820"
echo ""
