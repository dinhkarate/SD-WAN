...
# Script tự động tạo wg0.conf với keys đã điền sẵn
#
# SỬ DỤNG TABLE RIÊNG:
...
echo ""
echo "================================================"
echo "  ✅ VPS1 Setup hoàn tất!"
echo "================================================"
echo ""
echo "🔑 VPS1 PUBLIC KEY:"
echo "================================================"
...
echo "  - VPS1 vẫn dùng table main → không mất SSH"
echo "  - Kiểm tra route: ip route show table 51820"
echo "  - Kiểm tra rule: ip rule show"
echo ""
